    ...
    <>
      ...
      <section className={styles.heroDarkFull}>
        <div className={styles.heroInner}>
          ...
          <h1 className={styles.heroTitle}>Properties in {cityName}</h1>
      ...
      <main className={styles.dynamicContainer}>
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>Areas in {cityName}</h2>

          <div className={styles.pillGrid}>
            {areas.length === 0 ? (
              <p className={styles.sectionDesc}>No area data available for this city.</p>
            ) : (
              areas.map((area) => (
                <Link
                  key={area.slug}
        ...
        <section className={styles.sectionLight}>
          <h3 className={styles.sectionSubTitle}>Why Buy Property in {cityName}?</h3>
        ...
        <section className={styles.cityCtaBanner}>
          <div>
            <h3 className={styles.ctaTitle}>List Your Property in {cityName}</h3>
            <p className={styles.ctaDesc}>Reach verified buyers and renters in your city.</p>
          </div>
