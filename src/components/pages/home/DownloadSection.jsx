        ...
        >
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            <div className="relative mx-auto h-[340px] w-[208px] sm:h-[400px] sm:w-[240px] lg:mx-0 lg:h-[460px] lg:w-[276px]">
              ...
              <div className="relative h-full w-full rotate-[-2deg] transform transition-transform duration-500 hover:rotate-0">
                <div
                  className={`absolute inset-0 rounded-[2.5rem] border-[8px] bg-[var(--home-device-shell-bg)] shadow-2xl ${isDark ? "border-slate-700" : "border-slate-900"}`}
                >
