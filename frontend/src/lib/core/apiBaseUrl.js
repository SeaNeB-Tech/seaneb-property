...
const NEXT_ENV = String(process.env.NEXT_ENV || "development").trim().toLowerCase();
const DEV_API_URL = normalizeUrl(process.env.NEXT_PUBLIC_DEV_URL || "");
const CENTRAL_API_URL = normalizeUrl(process.env.NEXT_PUBLIC_CENTRAL_URL || "");
